	...
	*/
	...
	createOverlays: function createOverlaysFn() {
		/*
			...
			AR.ImageDrawable. A drawable is a visual component that can be connected to an IR target (AR.ImageTrackable) or a geolocated
	...
	onRecognition: function onRecognitionFn(recognized, response) {
		if (recognized) {
			...
			*/
			...
			/*
				The last line combines everything by creating an AR.ImageTrackable with the CloudRecognitionService, the name of the image target and the drawable that should augment the recognized image.
