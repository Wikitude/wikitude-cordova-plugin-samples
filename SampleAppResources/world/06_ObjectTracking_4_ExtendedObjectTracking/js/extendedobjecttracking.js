var World = {
    ...
    createCones: function createConesFn() {
        var coneDistanceInner = this.firetruckLength * 0.8;
        var coneDistanceOuter = this.firetruckLength * 3;

        World.drawables.push(World.getCone(-coneDistanceInner, +coneDistanceInner));
        World.drawables.push(World.getCone(+coneDistanceInner, +coneDistanceInner));
        World.drawables.push(World.getCone(+coneDistanceInner, -coneDistanceInner));
        World.drawables.push(World.getCone(-coneDistanceInner, -coneDistanceInner));

        World.drawables.push(World.getCone(-coneDistanceOuter, +coneDistanceOuter));
        World.drawables.push(World.getCone(+coneDistanceOuter, +coneDistanceOuter));
        World.drawables.push(World.getCone(+coneDistanceOuter, -coneDistanceOuter));
        World.drawables.push(World.getCone(-coneDistanceOuter, -coneDistanceOuter));
    },
    ...
    createTracker: function createTrackerFn() {
        ...
        this.objectTrackable = new AR.ObjectTrackable(this.tracker, "*", {
            ...
            extendedTarget: "*",
            onExtendedTrackingQualityChanged: this.extendedTrackingQualityChanged
        });
    },
    ...
    stopExtendedTracking: function () {
        World.objectTrackable.stopExtendedTracking();
        World.removeTrackingIndicator();
