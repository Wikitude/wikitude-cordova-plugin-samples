    ...
    */
    ...
    init: function initFn() {
        ...
        /*
            ...
            In case the instant tracker is active, it's trackable can be used to convert screen coordinates in potential scene coordinates.

            The trackable API to do this requires the scene coordinate for which the hit test should be performed. This example uses the onScreenClick callback to retrieve screen coordinates.
            The other two parameters are callbacks that are called in case the screen coordinate could be converted in scene coordinates or not.
            In case the screen coordinate could be converted successfully, a translate information is provided that can be used to position any AR.Drawable.
        */
